...
const MainPage = () => {
  ...
  const { data: monthlyActivity, isLoading: isMonthlyActivityLoading } = useQuery({
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {isLoading
                ? "..."
                : (stats?.totalPRs || 0).toLocaleString()}
            </div>
            <p className="text-xs text-muted-foreground">
              All time
            </p>
                ...
                <div className='h-80 w-full'>
                  <ResponsiveContainer width={"100%"} height={"100%"}>
                    <BarChart data={monthlyActivity || []}>
                      ...
                      <Bar dataKey="pullRequests" name="Pull Requests" fill="#8b5cfe" radius={[4,4,0,0]} />
